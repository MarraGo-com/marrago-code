// /src/themes/default/experiences/ExperiencesPageLayout.tsx (UPDATED)
'use client';
...
const FilterControls = dynamic(() => import(`@/components/experience/FilterControls`));
      ...
      <main className="flex-grow">
        <Container maxWidth="lg" sx={{ py: { xs: 4, md: 8 } }}>
          <Box sx={{ textAlign: 'center', mb: 4 }}>
            ...
            <MainHeadingUserContent title={content.title} sx={{ fontWeight: 'bold', mb: 2 }} />
            {/* UPDATED: Typography now gets subtitle from client data */}
            <Typography variant="h6" component="p" sx={{ color: 'text.secondary', maxWidth: '600px', mx: 'auto' }}>{content.subtitle}</Typography>
          </Box>
